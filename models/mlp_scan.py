...
class CNN_SimpleScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        w1, w2, w3 = weights
        #assert w1.shape == (8 * 24, 8)
        #assert w2.shape == (8, 16)
        #assert w3.shape == (16, 4)
        #[Cin * kernel, Cout] --> [out channels, kernel size, in channels] --> [out channels, in channels, kernel size]
